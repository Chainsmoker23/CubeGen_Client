                ...
                <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-lg space-y-6 border border-[#F9D7E3]">
                  ...
                  <div>
                   ...
                   <div className="pt-4 text-center border-t border-pink-100">
                     ...
                     <a href="https://www.linkedin.com/company/cubegen-ai" className="inline-flex items-center gap-2 font-semibold text-blue-600 hover:text-blue-800 transition-colors">
