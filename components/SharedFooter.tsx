...
type Page = 'contact' | 'about' | 'api' | 'privacy' | 'terms' | 'docs' | 'careers' | 'research' | 'apiKey' | 'blog' | 'guide';
...
const SharedFooter: React.FC<SharedFooterProps> = ({ onNavigate, activePage }) => {
  const validPages: (Page)[] = ['about', 'blog', 'guide', 'api', 'research', 'docs', 'careers', 'contact', 'privacy', 'terms', 'apiKey'];
