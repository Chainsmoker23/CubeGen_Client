...
import { CLOUD_LIBRARY_ICONS } from './cloudLibrary';

export const ICONS: Record<string, React.ReactNode> = {
  // --- Redesigned AWS Icons ---
  // --- Redesigned AWS Icons (Official Colors & Shapes) ---
  ...
  [IconType.AwsEcs]: <path d="M12 1.25L2.8 6.42v11.16L12 22.75l9.2-5.17V6.42L12 1.25Zm0 2.21l7.2 4.04v9.01L12 20.55L4.8 16.51V7.5L12 3.46Z M8 8h3v3H8V8Zm5 0h3v3h-3V8Zm-5 5h3v3H8v-3Zm5 0h3v3h-3v-3Z" fill="#FF9900" />,
  ...
  [IconType.AwsCloudfront]: <path d="M12 1.25L2.8 6.42v11.16L12 22.75l9.2-5.17V6.42L12 1.25Z M12 8c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2Zm-4 5c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2Zm8 0c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2Z" fill="#8C4FFF" />,
  ...
  [IconType.AzureSqlDatabase]: <g fill="#0078D4"><path d="M12 2c5.52 0 10 2.24 10 5s-4.48 5-10 5s-10-2.24-10-5S6.48 2 12 2z" /><path d="M2 12c0 2.76 4.48 5 10 5s10-2.24 10-5v-3c0 2.76-4.48 5-10 5S2 11.76 2 9v3z" /><path d="M16 16.5l3 3l-3 3M12 16.5v6M8 16.5l-3 3l3 3" stroke="white" strokeWidth="2" /></g>,
  [IconType.AzureAppService]: <path d="M22 6L12 1L2 6v12l10 5l10-5V6z M12 3.5l6 3l-6 3l-6-3l6-3z M4 7.5l6 3v7l-6-3v-7z m16 0v7l-6 3v-7l6-3z" fill="#0078D4" />,
  [IconType.AzureFunctionApp]: <path d="M12 2L2 22h20L12 2z m-1 15v-4h-2l4-5v4h2l-4 5z" fill="#3999C6" />,
  [IconType.AzureServiceBus]: <path d="M2 6h20v12H2V6z m2 2v8h16V8H4z m4 2h8v4H8v-4z" fill="#3999C6" />,
  ...
  [IconType.GcpCloudSql]: <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm2 15h-4v-2h4v2zm2-4H8V7h8v6z" fill="#4285F4" />,
  [IconType.GcpBigquery]: <g fill="#4285F4"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14h-2v-2h2v2zm2-4H9V7h4v5zM15 18l-1.5-1.5l1.5-1.5l1.5 1.5L15 18z" /></g>,
  [IconType.GcpPubsub]: <g fill="#4285F4"><circle cx="6" cy="6" r="3" /><circle cx="18" cy="6" r="3" /><circle cx="12" cy="18" r="3" /><path d="M8 8l2 8h4l2-8H8z" opacity="0.5" /></g>,
